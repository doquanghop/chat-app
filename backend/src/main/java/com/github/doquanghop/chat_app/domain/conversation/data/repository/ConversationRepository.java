package com.github.doquanghop.chat_app.domain.conversation.data.repository;
...
public interface ConversationRepository extends JpaRepository<Conversation, String> {
    ...
    @Query("""
            SELECT c FROM Conversation c
                ...
                WHERE c.type = com.github.doquanghop.chat_app.domain.conversation.data.model.ConversationType.PRIVATE
