...
import com.github.doquanghop.chat_app.domain.account.data.dto.SessionStatusDTO;
import com.github.doquanghop.chat_app.domain.account.data.model.Session;
import com.github.doquanghop.chat_app.domain.account.data.repository.SessionRepository;
...
import com.github.doquanghop.chat_app.infrastructure.utils.DeviceIdUtils;
...
public class SessionServiceImpl implements SessionService {
    ...
    public String getSessionId(String accountId) {
        ...
        Session session = sessionRepository.findByDeviceId(deviceId)
                .orElseThrow(() -> new AppException(ResourceException.ACCESS_DENIED, "Session not found"));
